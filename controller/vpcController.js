...
async function aws_login(req, res) {
    try {
        ...
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/main.tf', tfConfig);

        // Define the relative path to the Terraform configuration directory
        const configPath = '/home/jeya/Music/aws_vpc_creation';
...
async function aws_vpc(req, res) {
  ...
  tags = {
    Name = "${req.body.tag_name}"
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/vpc.tf', tfConfig);
...
async function aws_pub_subnet(req, res) {
    try {
      ...
      resource "aws_subnet" "${req.body.sn_name}" {
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/pub_subnet.tf', tfConfig);
...
async function aws_pvt_subnet(req, res) {
    try {
      ...
      resource "aws_subnet" "${req.body.sn_name}" {
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/pvt_subnet.tf', tfConfig);
...
async function internet_gateway(req, res) {
    try {
      ...
      resource "aws_internet_gateway" "${req.body.ig_name}" {
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/ig.tf', tfConfig);
...
async function route_table_pub(req, res) {
    try {
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/pub_route_table.tf', tfConfig);
...
async function route_table_pvt(req, res) {
    try {
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/pvt_route_table.tf', tfConfig);
...
async function pub_subnet_association(req, res) {
    try {
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/pub_subnet_association.tf', tfConfig);
...
async function pvt_subnet_association(req, res) {
    try {
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/pvt_subnet_association.tf', tfConfig);
...
// //TO CREATE SECURITY GROUP FOR PUBLIC
// async function security_group(req, res) {
//     try {
//         const tfConfig = `
...
//             vpc_id      = "${req.body.vpc_id}"
//             ingress {
//               from_port        = "${req.body.ingress_from_port}"
//               to_port          = "${req.body.ingress_to_port}"
//               protocol         = "${req.body.ingress_protocol}"
//               cidr_blocks      = ["${req.body.ingress_cidr_blocks}"]
//               ipv6_cidr_blocks = ["${req.body.ipv6_cidr_blocks}"]
//             }
//             egress {
//               from_port        = "${req.body.egress_from_port}"
//               to_port          = "${req.body.egress_to_port}"
//               protocol         = "${req.body.egress_protocol}"
//               cidr_blocks      = ["${req.body.egress_cidr_blocks}"]
//               ipv6_cidr_blocks = ["${req.body.ipv6_cidr_blocks}"]
//             }
//             tags = {
//               Name = "${req.body.tag_name}"
...
//         // Write the Terraform configuration to a file
//         fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/security_group.tf', tfConfig);
...
//     catch (error) {
//         console.log("error is : ", error)
//         res.send("An error occurred (SECURITY GROUP )");
//     }
// }
...
async function pub_security_group(req, res) {
    try {
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/pub_security_group.tf', tfConfig);
...
async function pvt_security_group(req, res) {
    try {
        ...
        // The rest of your code remains unchanged
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/pvt_security_group.tf', tfConfig);
    ...
    try {
        ...
        data "aws_ami" "${req.boby.os_name}" {
          ...
          resource "aws_instance" "my_ec2"{
              ...
              instance_type = "${req.boby.instance_type}"
        ...
        // Write the Terraform configuration to a file
        fs.writeFileSync('/home/jeya/Music/aws_vpc_creation/ec2_instance.tf', tfConfig);
